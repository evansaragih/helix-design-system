...
const VARIANTS: Record<AlertVariant, VariantTokens> = {
  ...
  info: {
    ...
    border:      'var(--primitive-blue-10, #BFDBFE)',
    iconColor:   'var(--color-text-info, #014CC5)',
    actionBg:    'var(--color-text-info, #014CC5)',
    actionText:  '#FFFFFF',
    badgeVariant: 'blue',
    DefaultIcon: Info,
  },
  success: {
    ...
    border:      'var(--primitive-green-10, #AAEBBF)',
    iconColor:   'var(--color-text-success, #12843C)',
    actionBg:    'var(--color-text-success, #12843C)',
    actionText:  '#FFFFFF',
    badgeVariant: 'green',
  ...
  warning: {
    ...
    border:      'var(--primitive-yellow-20, #FBDA8E)',
    iconColor:   'var(--color-text-warning, #A66800)',
    actionBg:    'var(--color-text-warning, #A66800)',
    actionText:  '#FFFFFF',
    badgeVariant: 'yellow',
  ...
  error: {
    ...
    border:      'var(--primitive-red-10, #FCA5A5)',
